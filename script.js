document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            hero_subtitle: "중앙 서버도, 감시자도 없습니다. 개발사인 저희조차 당신의 메시지를 볼 수 없습니다. Zero는 세계에서 가장 진보된 프라이버시 기술로 완벽한 익명성을 보장합니다.",
            hero_btn_whitepaper: "화이트페이퍼 읽기",
            trust_title: "깨지지 않는 신뢰",
            trust_subtitle: "Zero는 수학적으로 프라이버시가 보호되도록 설계되었습니다. 사람이 개입할 여지를 없애 당신의 데이터는 오직 당신의 것으로 남습니다.",
            trust_server_title: "서버 무지 (Zero Knowledge)",
            ...
            features_subtitle: "전문가용: 절대적인 프라이버시를 가능하게 하는 딥테크 기술들입니다.",
        ...
        en: {
            ...
            hero_subtitle: "No central servers, no prying eyes. Not even we can see your messages. Zero ensures absolute anonymity using the world's most advanced privacy technology.",
            hero_btn_whitepaper: "Read Whitepaper",
            trust_title: "Unbreakable Trust",
            trust_subtitle: "Zero is designed to be mathematically private. We removed the human factor so your data stays yours.",
            trust_server_title: "Zero Server Knowledge",
            ...
            features_subtitle: "For the curious: The deep-tech that makes absolute privacy possible.",
            feature_dksap_title: "DKSAP (ECC)",
        ...
        ja: {
            ...
            hero_subtitle: "中央サーバーも、監視者もありません。開発元である私たちでさえ、あなたのメッセージを見ることはできません。Zeroは世界で最も進んだプライバシー技術で完全な匿名性を保証します。",
            hero_btn_whitepaper: "ホワイトペーパーを読む",
            trust_title: "破られない信頼",
            trust_subtitle: "Zeroは数学的にプライバシーが保護されるように設計されています。人間の介入を排除し、あなたのデータはあなただけのものになります。",
            trust_server_title: "サーバー・ゼロ知識",
            trust_server_desc: "サーバーは暗호化されたノイズしか見ることができません。あなたの身元やメッセージの内容は、ネットワーク運用者にも見えません。",
            trust_keys_title: "主権적鍵",
            ...
            features_subtitle: "専門家向け：絶対的なプライバシーを可能にするディープテック技術です。",
            feature_dksap_title: "DKSAP (ECC)",
        ...
        zh: {
            ...
            hero_subtitle: "没有中央服务器，没有监视者。甚至连我们（开发团队）也无法查看你的信息。Zero 利用全球最先进的隐私技术确保绝对的数据匿名。",
            hero_btn_whitepaper: "阅读白皮书",
            trust_title: "不可逾越的信任",
            trust_subtitle: "Zero 在数学设计上确保隐私。我们消除了人为干预，让你的数据永远只属于你。",
            trust_server_title: "服务器零知识",
            ...
            features_subtitle: "专为极客打造：让绝对隐私成为可能的深层技术。",
            feature_dksap_title: "DKSAP (ECC)",
        ...
        es: {
            ...
            hero_subtitle: "Sin servidores centrales, sin miradas indiscretas. Ni siquiera nosotros podemos ver tus mensajes. Zero garantiza el anonimato absoluto mediante la tecnología de privacidad más avanzada del mundo.",
            hero_btn_whitepaper: "Leer Whitepaper",
            trust_title: "Confianza Inquebrantable",
            trust_subtitle: "Zero está diseñado para ser matemáticamente privado. Eliminamos el factor humano para que tus datos sigan siendo tuyos.",
            trust_server_title: "Conocimiento Cero del Servidor",
            ...
            features_subtitle: "Para los curiosos: La tecnología profunda que hace posible la privacidad absoluta.",
            feature_dksap_title: "DKSAP (ECC)",
