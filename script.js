document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            features_subtitle: "전문가를 위한 기술 상세: 절대적 프라이버시를 구현하는 핵심 암호화 프로토콜",
        ...
        en: {
            ...
            features_subtitle: "Technical Deep Dive: Core cryptographic protocols that enable absolute privacy",
            feature_dksap_title: "DKSAP (ECC)",
        ...
        ja: {
            ...
            features_subtitle: "技術詳細：絶対的プライバシーを実現するコア暗号化プロトコル",
            feature_dksap_title: "DKSAP (ECC)",
        ...
        zh: {
            ...
            features_subtitle: "技术深度解析：实现绝对隐私的核心加密协议",
            feature_dksap_title: "DKSAP (ECC)",
        ...
        es: {
            ...
            features_subtitle: "Análisis Técnico: Protocolos criptográficos fundamentales que permiten privacidad absoluta",
            feature_dksap_title: "DKSAP (ECC)",
