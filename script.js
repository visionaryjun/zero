document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ko: {
            ...
            hero_title: "세상에서 가장 안전한 영지식 메신저, Zero",
            hero_subtitle: "중앙 서버도, 감시자도 없습니다. 당신과 대화 상대방만이 메시지를 읽을 수 있는 유일한 사람입니다. Zero는 세계 최고 수준의 암호화 기술로 완벽한 익명성을 보장하는 사설 메신저입니다.",
        ...
        en: {
            ...
            hero_title: "Zero: The World's Most Secure Zero-Knowledge Messenger",
            hero_subtitle: "No central servers, no prying eyes. You and your recipient are the only ones who can ever read your messages. Zero ensures absolute anonymity using world-class cryptographic technology.",
        ...
        zh: {
            ...
            hero_title: "Zero: 全球最安全的零知识隐私信使",
            hero_subtitle: "没有中央服务器，没有监视者。您和您的收件人是唯一能够阅读您的消息的人。Zero 利用世界顶级加密技术确保绝对的通信匿名。",
        ...
        es: {
            ...
            hero_title: "Zero: El Mensajero Cero-Knowledge Más Seguro del Mundo",
            hero_subtitle: "Sin servidores centrales, sin miradas indiscretas. Tú y tu destinatario son los únicos que podrán leer tus mensajes. Zero garantiza el anonimato absoluto mediante tecnología criptográfica de clase mundial.",
